...
#     <col_name>_fctr=factor(<col_name>, 
#                 as.factor(union(glb_entity_df$<col_name>, glb_predct_df$<col_name>))), 
#     <col_name>_fctr_num=grep(<col_name>, levels(<col_name>_fctr)), # This doesn't work
#     
...
# glb_entity_df$<col_name>_fctr_num <- sapply(1:nrow(glb_entity_df), 
#     function(row_ix) grep(glb_entity_df[row_ix, "<col_name>"],
#                           levels(glb_entity_df[row_ix, "<col_name>_fctr"])))

# glb_predct_df <- mutate(glb_predct_df, 
#                     )

# glb_predct_df$<col_name>_fctr_num <- sapply(1:nrow(glb_predct_df), 
#     function(row_ix) grep(glb_predct_df[row_ix, "<col_name>"],
#                           levels(glb_predct_df[row_ix, "<col_name>_fctr"])))
