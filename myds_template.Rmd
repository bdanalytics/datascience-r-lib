...
# Rename glb_*obs_df to glb_obs*_df to keep it together in the Environment panel ?
...
#                                 c("MFO.myMFO_classfr", "Baseline.mybaseln_classfr"))) - 1
    mdl_threshold_pos <- 
        min(which(grepl("MFO|Random|Baseline", tmp_models_df$model_id))) - 1
    ...
    model_id <- "Ensemble"; #method <- tail(unlist(strsplit(glb_sel_mdl_id, "[.]")), 1)
...
#stop(here"); glb_to_sav()    
    ...
    require(gdata)
    ret_lst <- myfit_mdl(model_id=ifelse(grepl("Ensemble", glb_sel_mdl_id),
