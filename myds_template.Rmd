...
glb_analytics_pn <- petrinet(name="glb_analytics_pn",
    ...
    name=c("data.new","model.final","data.new.prediction"),
    x=c(   -5,        -5,           -15),
    y=c(   -5,         5,             0)
                        ),
                        places_df=data.frame(id=1:3,
                            name=c("bgn","predict.data.new","end"),
                            x=c(   -0,   -10,               -20),
                            y=c(    0,     0,                 0),
                            M0=c(   1,     0,                 0)
                        ),
                        arcs_df=data.frame(
    begin=c("bgn",        "bgn",    "model.final",    "data.new",        "predict.data.new",
"data.new.prediction"),
    end  =c("model.final","data.new","predict.data.new","predict.data.new","data.new.prediction",
"end")
                        ))
...
## Step ``r glb_script_df[nrow(glb_script_df), "chunk_step_major"]``: fit training.all
