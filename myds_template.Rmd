...
setwd("~/Documents/Work/<scriptPath>")
```
...
glbObsTrnFileName <- list(url = "<obsTrnFileName>") 
glbObsNewFileName <- list(url = "<obsNewFileName>")
...
glbObsTrn <- myimport_data(url=glbObsTrnFileName, comment="glbObsTrn", 
                                force_header=TRUE)
...
#     sym_trnobs_df <- 
#         myimport_data(url=gsub("IBM", symbol, glbObsTrnFileName), comment="glbObsTrn", 
#                                     force_header=TRUE)
...
if (glb_is_separate_newobs_dataset) {
    glbObsNew <- myimport_data(url=glbObsNewFileName, comment="glbObsNew", 
                                   force_header=TRUE)
