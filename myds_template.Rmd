...
glbChunks[["inpFilePathName"]] <- NULL # NULL: default or "data/Votes_Q_01_cnk_manage.missing.data.RData"
...
#stop(here"); glb2Sav(); glbObsAll <- savObsAll
    ...
    cluster_vars_df <- data.frame(abs.cor.y = abs(cor(
                        glbObsAll[glbObsAll$.src == "Train", glbFeatsCluster],
            as.numeric(glbObsAll[glbObsAll$.src == "Train", glb_rsp_var]),
                                    use = "pairwise.complete.obs")))
...
#         print(dim(ctgry_allobs_df))
        print(ctgry_allobs_df[c(row_ix, col_ix), 
            c(glbFeatsId, glb_cluster_entropy_var, glbFeatsCategory, glbFeatsText, glbFeatsCluster)])
