...
# ```{r cluster.data, cache=FALSE, echo=FALSE, eval=myevlChunk(glbChunks, glbOut$pfx, keep = c("glb_cluster"))}
#myloadChunk(glbOut$pfx, glbChunks$labels[match("cluster.data", glbChunks$labels, nomatch = -1) - 1], keep = c("glb_cluster"))
#keep = c("glbFeatsCategory","glb_dsp_cols")) # if glbFeatsCategory needs to be changed
