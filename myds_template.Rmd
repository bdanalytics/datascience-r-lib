...
glb_out_pfx <- "NYTBlogs_parse_"
glb_save_envir <- TRUE # or FALSE
...
#stop("here"); sav_txt_lst <- glb_txt_lst; all.equal(sav_txt_lst, glb_txt_lst)
...
#sum(mycount_pattern_occ("Recap:", glb_allobs_df$Headline) > 0)
...
if (glb_cluster) {
    ...
    for (myCategory in c("Science#Health#")) {
        ctgry_entity_df <- glb_allobs_df[glb_allobs_df$myCategory == myCategory, ]
...
dsp_myCategory_conf_mtrx <- function(myCategory) {
    ...
    OOBerr_df <- glb_OOBobs_df[(glb_OOBobs_df$UniqueID %in% err_ids) & 
