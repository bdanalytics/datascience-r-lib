...
glb_script_df <- data.frame(chunk_label="import_data", chunk_step_major=1, chunk_step_minor=0)
print(glb_script_df)
```
...
## Step ``r glb_script_df[nrow(glb_script_df), "chunk_step_major"]``: predict newdata
