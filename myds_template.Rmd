...
glb_is_separate_newobs_dataset <- FALSE    # or TRUE
    glb_split_entity_newobs_datasets <- TRUE   # select from c(FALSE, TRUE)
...
glb_id_var <- c(NULL 
                , "<id>") # currently does not handle more than 1 column ??? consider concatenating multiple columns
glb_category_var <- c(NULL
                , "<category>") # currently does not handle more than 1 column ??? consider concatenating multiple columns
...
#print(mod_raw <- grep("&#034;", glb_allobs_df[, txt_var], value = TRUE)) 
#print(mod_raw <- glb_allobs_df[c(88,187,280,1040,1098), txt_var])
#print(mod_raw <- glb_allobs_df[sel_obs(list(descr.my.contains="\\bdoes( +)not\\b")), glbFeatsText])
#print(mod_raw <- glb_allobs_df[sel_obs(list(descr.my.contains="\\bipad [[:digit:]]\\b")), glbFeatsText][01:10])
#print(mod_raw <- glb_allobs_df[sel_obs(list(descr.my.contains="pad mini")), glbFeatsText][11:20])
#print(mod_raw <- glb_allobs_df[sel_obs(list(descr.my.contains="pad mini")), glbFeatsText][21:30])
#print(mod_raw <- glb_allobs_df[sel_obs(list(descr.my.contains="pad mini")), glbFeatsText][31:40])
...
glb_sel_mdl_id <- NULL #select from c(NULL, "All.X.glmnet", "RFE.X.glmnet", <mdlId>)
...
if (!is.null(glbOutDataVizFname))
    write.csv(glb_allobs_df, glbOutDataVizFname, row.names=FALSE)
...
#                                     c("UniqueID", "Popular", "Abstract", "A.npnct23.log")]))    
        ...
        txt_X_df[, paste0(txt_var_pfx, ".chrs.iso8859.n.log")] <- 
            log1p(mycount_pattern_occ("&#[[:digit:]]{3};", glb_allobs_df[, txt_var]))
        ...
        txt_X_df[, paste(txt_var_pfx, ".P.http", sep="")] <- 
            log1p(mycount_pattern_occ("http", glb_allobs_df[, txt_var]))
...
for (txt_var in glbFeatsText) {
    ...
    #print(glb_allobs_df[which(TfIdf_mtrx[, 207] > 0), c(glb_id_var, glbFeatsText)])
